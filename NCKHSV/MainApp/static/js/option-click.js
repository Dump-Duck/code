document.addEventListener('DOMContentLoaded', function () {
    ...
    [houseTypeSelect, districtSelect, wardSelect, priceSelect, areaSelect].forEach((select) => {
      select.addEventListener("change", () => {
        // If the user selects a non-default option for any select element, show the submit button
        if (houseTypeSelect.value !== "" ||  districtSelect.value !== "" || wardSelect.value !== "" || priceSelect.value !== "" || areaSelect.value !== "") {
